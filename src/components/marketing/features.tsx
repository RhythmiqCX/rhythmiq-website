            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        AI-Powered Customer Service <br /> made <span className="font-subheading italic">simple</span>
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Transform your Customer Service with AI-powered automation. Resolve Issues faster, without human intervention, and automate support.
                    </p>
                </div>
            </Container>
