        ...
        <Container className="flex flex-col gap-8 md:gap-12">
          ...
          <div className="flex flex-col items-center text-center gap-6 max-w-3xl mx-auto">
            <h1 className="h-section">
              ...
              <span className="text-coral">for Tagalog</span>
            </h1>
          ...
          <div className="max-w-3xl mx-auto w-full space-y-6 text-ink2 text-sm leading-relaxed border-t border-ink/10 pt-10">
            <h2 className="text-xl font-bold text-ink">About This Tagalog AI Voice Generator</h2>
            <p>
            ...
            <h3 className="text-base font-semibold text-ink">Popular Use Cases</h3>
            ...
            <p>
              ...
              <Link href="/voice-ai" className="text-coral hover:underline">AI Receptionist for Philippines</Link> or the full{" "}
              <Link href="/voice-ai" className="text-coral hover:underline">RhythmiqCX Voice AI platform</Link>.
            </p>
          </div>
