      ...
      <Wrapper className="relative z-10">
        <Container className="flex flex-col gap-8 md:gap-12">
          ...
          <div className="flex flex-col items-center text-center gap-6 max-w-3xl mx-auto">
            <div className="inline-flex items-center rounded-full border border-coral/20 bg-coralSoft px-3 py-1 text-xs font-medium text-coral">
              Powered by Sarvam Bulbul v2
            </div>
            <h1 className="h-display">
              Indian English <br />
              <span className="text-coral">AI Voice Generator</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm text-ink2">
          ...
          <div className="max-w-3xl mx-auto w-full space-y-6 text-ink2 text-sm leading-relaxed border-t border-ink/10 pt-10">
            <h2 className="text-xl font-bold text-ink">Why Sarvam Bulbul v2 for Indian English?</h2>
            <p>
            ...
            <h3 className="text-base font-semibold text-ink">Use Cases for Indian English AI Voice</h3>
            ...
            <p>
              ...
              see <Link href="/voice-ai" className="text-coral hover:underline">Voice AI for India</Link>.
              Also explore our <Link href="/tools/ai-hindi-voice-generator" className="text-coral hover:underline">AI Hindi Voice Generator</Link> for Hindi-language TTS.
            </p>
          </div>
