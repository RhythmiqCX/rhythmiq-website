...
export default function CTCCalculatorPage() {
  return (
    <div className="relative w-full py-20 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-emerald-500/10 blur-[120px] rounded-full -z-10 opacity-50 pointer-events-none" />
        ...
        <Container className="flex flex-col gap-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 pt-12 border-t border-border/40">
            <div className="space-y-4">
              <h3 className="text-xl font-semibold">Compare Job Offers</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold">Tax Regime Comparison</h3>
              <p className="text-muted-foreground">
