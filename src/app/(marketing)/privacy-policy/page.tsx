    ...
    <main className="flex flex-col">
      ...
      <section className="py-20 bg-gradient-to-b from-blue-500/20 to-background text-center px-4">
        <div className="max-w-7xl mx-auto space-y-4">
          <h1 className="text-5xl font-bold text-gray-200">RhythmiqCX Privacy Policy</h1>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-invert max-w-none">
            ...
            <h2 className="font-bold mt-8 text-gray-200">1. What Qualifies as Personal Information</h2>
            <p className="text-gray-300">
            ...
            <h2 className="font-bold mt-8 text-gray-200">2. Applicability of GDPR</h2>
            <p className="text-gray-300">
            ...
            <p className="text-gray-300">We may collect Personal Information when you:</p>
            ...
            <p className="text-gray-300">
              <strong className="text-gray-200">Analytics –</strong> We use Google Analytics and similar tools
            ...
            <p className="text-gray-300">
              <strong className="text-gray-200">Social Media & Third-Party Logins –</strong> When you interact
            ...
            <p className="text-gray-300">
              <strong className="text-gray-200">Cookies –</strong> We use cookies and tracking technologies
            ...
            <h2 className="font-bold mt-8 text-gray-200">4. Accuracy of Information</h2>
            <p className="text-gray-300">
            ...
            <h2 className="font-bold mt-8 text-gray-200">5. How We Use Your Personal Information</h2>
            <p className="text-gray-300">We may use your Personal Information to:</p>
            <ul className="list-disc pl-6 text-gray-300">
            ...
            <p className="text-gray-300">
              ...
              please contact us at <strong className="text-gray-200">privacy@rhythmiqcx.com</strong>.
            </p>
            <p className="text-gray-300">
              <strong className="text-gray-200">Legal Basis (for EU Residents):</strong> Processing will be
              based on consent, contractual necessity, or legitimate interests, in
              line with GDPR requirements.
            </p>

            <h2 className="font-bold mt-8 text-gray-200">6. Whom Do We Disclose Your Data To?</h2>
            <p className="text-gray-300">
            ...
            <ul className="list-disc pl-6 text-gray-300">
              <li>
                <strong className="text-gray-200">Service Providers –</strong> With trusted partners who help
                us operate and maintain the Services.
              </li>
              <li>
                <strong className="text-gray-200">Business Transfers –</strong> If RhythmiqCX undergoes a
                merger, acquisition, or restructuring.
              </li>
              <li>
                <strong className="text-gray-200">Legal Requirements –</strong> To comply with applicable laws,
                regulations, or court orders.
              </li>
              <li>
                <strong className="text-gray-200">Participants –</strong> Details of collaborative interactions
            ...
            <h2 className="font-bold mt-8 text-gray-200">8. Data Retention</h2>
            <p className="text-gray-300">
            ...
            <h2 className="font-bold mt-8 text-gray-200">9. Security Measures</h2>
            <p className="text-gray-300">
            ...
            <h2 className="font-bold mt-8 text-gray-200">10. Your Rights (For EU Residents)</h2>
            <ul className="list-disc pl-6 text-gray-300">
            ...
            <p className="text-gray-300">
              ...
              <strong className="text-gray-200">privacy@rhythmiqcx.com</strong>.
            </p>

            <h2 className="font-bold mt-8 text-gray-200">11. Third-Party Links</h2>
            <p className="text-gray-300">
            ...
            <h2 className="font-bold mt-8 text-gray-200">12. Limitation of Liability</h2>
            <p className="text-gray-300">
            ...
            <h2 className="font-bold mt-8 text-gray-200">13. Governing Laws and Disputes</h2>
            <p className="text-gray-300">
            ...
            <h2 className="font-bold mt-8 text-gray-200">14. Changes to This Policy</h2>
            <p className="text-gray-300">
            ...
            <h2 className="font-bold mt-8 text-gray-200">15. Contact Us</h2>
            <p className="text-gray-300">
