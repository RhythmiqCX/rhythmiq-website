    ...
    <section className="section text-center" aria-label="Integrations">
      <div className="wrap">
        ...
        <p className="lede mt-5 max-w-[54ch] mx-auto">
          Rhythmiq does two way sync with your store platform, OMS/WMS, and CRM. It
          writes order updates and exchanges where your team already looks, so
          there are no new screens for anyone to learn.
        </p>
