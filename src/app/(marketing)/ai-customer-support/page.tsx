          ...
          <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
            <Container>
              <h1 className="text-4xl md:text-4xl lg:text-7xl font-bold text-center !leading-tight max-w-4xl mx-auto">
                AI Customer Support <span className="">Chatbot </span>
                {/* with AI */}
              </h1>
            </Container>
            <Container delay={0.2}>
              <p className="max-w-xl mx-auto mt-2 text-base lg:text-lg text-center text-muted-foreground">
                ...
                Automate tickets, boost CSAT and delight customers 24x7 across
                web, WhatsApp & more.
              </p>
            </Container>
      ...
      <section className="py-12 mx-4 md:py-16">
        <Container>
          <p className="mx-auto max-w-3xl text-lg md:text-xl font-medium leading-relaxed">
            <strong>AI customer support</strong> is the use of conversational AI
            — large language model chatbots, intent detection and automated
            workflows to resolve customer questions without a human agent. It
            hooks into your existing help desk, knowledge base and channels so
            customers get instant, accurate answers 24 hours a day.
          </p>
        </Container>
      </section>
        ...
        <div className="container mx-auto">
          ...
          <ul className="grid gap-8 md:grid-cols-2">
            <li className="space-y-2">
              <h3 className="text-xl font-semibold">Web & In App Chatbot</h3>
              <p>
            ...
            <li className="space-y-2">
              ...
              <p>
                Handle customer queries on Whatsapp directly from your
                integrated Inbox perfect for mobile as well as web users.
              </p>
            </li>
            <li className="space-y-2">
              <h3 className="text-xl font-semibold">Multilingual NLP</h3>
              <p>
            ...
            <li className="space-y-2">
              <h3 className="text-xl font-semibold">Live Agent Handoff</h3>
              <p>
                Seamlessly transfer complex cases to actual Cutomer Support
                representatives or your CRM with full context & AI generated
                summaries.
              </p>
            </li>
          </ul>
        ...
        <Container className="space-y-10 max-w-4xl mx-auto">
          ...
          <ol className="space-y-8 list-decimal list-inside">
            <li>
              ...
              <p>
                Choose the Web, WhatsApp, or Omni plan and invite up to 5
                agents. Need more seats? You can add them anytime as add‑ons.
              </p>
            </li>
            <li>
              <h4 className="font-semibold">Connect Your Channels</h4>
              <p>
                Embed our web chat widget on your site and link your WhatsApp
                Business number. We handle BSP setup and template approval for
                you.
              </p>
            </li>
            <li>
              ...
              <p>
                Sync FAQs, help‑centre articles, and policy docs so our AI
                replies with accurate, brand‑approved answers.
              </p>
            </li>
            <li>
              <h4 className="font-semibold">
                Configure AI Intents & Fallbacks
              </h4>
              <p>
                Label your key topics (e.g. orders, returns, account issues) and
                set confidence thresholds. Low‑confidence chats automatically go
                to live agents.
              </p>
            </li>
            <li>
              ...
              <p>
                Track chat deflection, CSAT, and conversation volume. Adjust
                prompts, expand KB, or increase quotas to continuously improve
                support.
              </p>
            </li>
          </ol>
          ...
          {[
            {
              ...
              title: "WhatsApp AI Chatbot Guide",
              desc: "Launch compliant WhatsApp support with AI.",
            },
            {
              href: "/ai-chatbot-pricing",
              title: "AI Chatbot Pricing",
              desc: "Costs, vendor fees and ROI math.",
            },
            {
              href: "/conversational-ai-chatbot",
              title: "Conversational AI Chatbot Guide",
              desc: "Build natural, multi-turn chatbots powered by NLP and large-language models.",
            },
          ].map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="space-y-2 border p-6 rounded-xl hover:shadow-lg transition-shadow"
            >
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="space-y-6">
            <details className="p-4 border rounded-lg">
              ...
              <p className="mt-2">
                Yes. Our generative AI first tries to resolve the issue using
                your knowledge base. If confidence is low, it escalates to a
                live agent with a conversation summary so that nothing is lost.
              </p>
            </details>
            <details className="p-4 border rounded-lg">
              <summary className="font-semibold">
            ...
            <details className="p-4 border rounded-lg">
              ...
              <p className="mt-2">
                Yes. Data can be kept in region (depending on country). We
                encrypt at rest and in transit and keep full audit logs for
            ...
            <details className="p-4 border rounded-lg">
              ...
              <p className="mt-2">
                Over 60+ languages including English, Hindi, Bengali, Telugu,
                Tamil, Spanish, German, and French. Ideal for global products.
              </p>
            </details>
          </div>
        </div>
